...
$(function(){
	...
	function sendQueryRiskOrderListHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "pc/order/findThirdRiskManagementOrder";//order/queryOrdersMapController
		var condi = {};
		condi.login_token = g.login_token;
		condi.currentPageNum = g.currentPage;
		condi.status = "10050303";
    ...
    window.SaveCancel = function(orderId){
        ...
        var url = Base.serverUrl + "pc/order/cancelOrder";
        var condi = {};
        condi.login_token = g.login_token;
