...
$(function () {
    ...
    if (!loginStatus) {
        ...
        $.ajax({
            url: Base.serverUrl + "pc/order/findRiskManagementApproveInfo",
            ...
            success: function (data) {
                ...
                $("#fk1_approve_report").val(RowData.firstFkApproveReport);
                $("#fk1_approve_nameSpan").text(RowData.firstFkApproveName);
                $("#fk1_approve_remarks").val(RowData.firstFkApproveRemarks);
                $("#fk2_approve_report").val(RowData.secondFkApproveReport);
                $("#fk2_approve_nameSpan").text(RowData.secondFkApproveName);
    ...
    function fkSellerBtnUp(e) {
        ...
        var url = Base.serverUrl + "pc/order/thirdApproveOrder";
        //console.log(condi);
        $.ajax({
