...
$(function(){
	...
	function sendQueryRiskOrderListHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "pc/order/findRiskManagementOrder";//order/queryFKApproveOrdersController
		var condi = {};
	...
	function changeOrderListHtml(data){
		...
		for(var i = 0,len = obj.length; i < len; i++){
			...
			html.push('<td>' + (d.firstFkApproveName || "") +  '</td>');
			html.push('<td>' + (d.firstFkApproveTime || "") + '</td>');
			html.push('<td>' + (d.secondFkApproveName || "" ) + '</td>');
			html.push('<td>' + (d.secondFkApproveTime || "" ) + '</td>');
			html.push('<td>' + (d.thirdFkApproveName || "" ) + '</td>');
			html.push('<td>' + (d.thirdFkApproveTime || "" ) + '</td>');
