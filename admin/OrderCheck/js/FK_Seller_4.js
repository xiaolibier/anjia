...
$(function () {
    ...
    if (!loginStatus) {
        ...
        $.ajax({
            url: Base.serverUrl + "pc/order/findUpdateOrderInfo",
            ...
            success: function (data) {
                ...
                $("#fenQiTimes").val(RowData.fenQiTimes);
	...
	$("#poundageRepaymentType").bind('change',function(){changePoundageRepaymentType($("#poundageRepaymentType").val())});
