...
$(function () {
   /*  if(typeof eui !== "undefined"){
    ...
    function sendQueryOrderListHttp() {
        g.httpTip.show();
        var url = Base.serverUrl + "pc/report/getOrderStatisticByPcAction";//order/queryOrdersController
        var condi = {};
    ...
    window.OutXls = function(){
        ...
        Hmgx.serializeDownload(Base.serverUrl  + "pc/report/getOrderStatisticExportAction","CX",ParamObj);//order/queryOrdersControllerExport
    }
});