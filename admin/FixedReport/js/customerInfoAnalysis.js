...
$(function () {
    ...
    $("#outBut").bind("click", function(){
        ...
        Hmgx.serializeDownload(Base.serverUrl  + "pc/report/getCustomerInfoAnalysisExportAction","CX",ParamObj);//oplog/selectClentInfoReportExport
    });
    ...
    function sendQueryOrderListHttp() {
        g.httpTip.show();
        var url = Base.serverUrl + "pc/report/getCustomerInfoAnalysisByPcAction";//oplog/selectClentInfoReport
        var condi = {};
