...
$(function () {
   /*  if(typeof eui !== "undefined"){
    ...
    $("#outBut").bind("click", function(){
        ...
        Hmgx.serializeDownload(Base.serverUrl  + "pc/report/getCustomerRegistrationExportAction","CX",ParamObj);//oplog/selectClentRegisterReportExport
    });
    ...
    function sendQueryOrderListHttp() {
        g.httpTip.show();
        var url = Base.serverUrl + "pc/report/getCustomerRegistrationByPcAction";//oplog/selectClentRegisterReport
        var condi = {};
