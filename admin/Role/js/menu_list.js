...
$(function(){
	...
	**/
	...
	function sendAddMenuHttp(condi){
		g.httpTip.show();
		var url = Base.serverUrl + "common/auth/addAuthority";//authority/insertAuthority
		$.ajax({
			url:url,
			data:condi,
			type:"POST",
	...
	function deleteMenuById(){
		...
		if(confirm(msg)){
			...
			var url = Base.serverUrl + "common/auth/deleteAuthority";//authority/deleteAuthority
			$.ajax({
				url:url,
				data:condi,
				type:"POST",
	...
	function sendEditMenuHttp(condi){
		g.httpTip.show();
		var url = Base.serverUrl + "common/auth/updateAuthority";
		$.ajax({
			url:url,
			data:condi,
			type:"POST",
