...
$(function(){
	...
	function sendQueryTreeByRoleIdHttp(id){
		g.httpTip.show();
		var url = Base.serverUrl + "common/auth/findAuthorityByRoleId";//authority/queryAdminMenuByRoleId
		var condi = {};
		condi.login_token = g.login_token;
		condi.roleId = id;
	...
	function sendInsertTreeByRoleIdHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "common/auth/insertRoleAuthority";//roleAuthority/insertAdminMenuRoleAuthority
		var condi = {};
		condi.login_token = g.login_token;
	...
	**/
	...
	function sendQueryListHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "common/auth/findMenuTree";//authority/queryAdminMenuTree
		var condi = {};
		condi.login_token = g.login_token;
		condi.authoritySystem = 102301;
		//~ condi.pageSize = g.pageSize;
