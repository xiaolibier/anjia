...
$(function(){
	...
	*/
	...
	function sendQueryOrderListHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "pc/report/getFinanceWeeklyByPcAction";//oplog/financeWeekly
		var condi = {};
	...
	window.OutXls = function(){
        ...
        Hmgx.serializeDownload(Base.serverUrl  + "pc/report/getFinanceWeeklyExportAction","CX",ParamObj);//oplog/financeWeeklyExport
    }
});