...
$(function(){
	...
	function sendGetCompanyInfoHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "common/product/findByQuery";//order/queryProductController
		var condi = {};
		$.ajax({
			url:url,
			data:condi,
	...
	function sendQueryOrderListHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "pc/order/findloanOrder";//order/queryMerchantProceeds
		var condi = {};
