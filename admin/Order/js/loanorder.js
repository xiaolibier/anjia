...
$(function(){
	...
	$("#outBut").bind("click", function(){
		...
		Hmgx.serializeDownload(Base.serverUrl  + "pc/order/findLoanRecordByQueryExport","CX",ParamObj);
	});
	...
	*/
	...
	function sendQueryOrderListHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "pc/order/findLoanRecordByQuery";//order/queryLoanRecordByQuery
		var condi = {};
		condi.login_token = g.login_token;
		condi.companyId = $("#company").val() || "";
		if(condi.companyId == "20150901"){
			condi.companyId = "";
		}
	...
	function changeOrderListHtml(data){
		...
		for(var i = 0,len = obj.length; i < len; i++){
			...
			var loanMoney = d.loanMoney || 0;
			var status = d.status || "";
			var statusDesc = d.statusDesc || "";
			var applicationTime = d.applicationTime || "";
