...
/* 	if(typeof eui !== "undefined"){
	...
	function sendQueryListHttp(code){
		g.httpTip.show();
		var url = Base.serverUrl + "common/subsidiary/findByQuery";//subsidiary/getAllSubsidiarys
		var condi = {};
	...
	function deleteItem(id){
		if(confirm("你确认删除该用户吗?")){
			...
			var url = Base.serverUrl + "common/subsidiary/deleteSubsidiary";
			$.ajax({
				url:url,
				data:condi,
				type:"POST",
