...
$(function(){
	...
	function validForm(){
		...
		var url = Base.serverUrl + "common/subsidiary/updateSubsidiary";//subsidiary/updateSubsidiary
...
/* 	function sendGetNavigationKeyHttp(){
	...
	function sendGetBannerInfoById(){
		var bmId = g.bmId;
		g.httpTip.show();
		var url = Base.serverUrl + "common/subsidiary/findSubsidiaryById";//subsidiary/getSubsidiary
		var condi = {};
