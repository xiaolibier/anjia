...
define('text!components/top_bar/tpl.html', [
], function () {
...
define('components/top_bar/view', [
    ...
    return t.View.extend({
        ...
        render: function () {
            var i = 1;
            return '/' === t.history.location.pathname && (i = !1),
...
define('text!apps/home/templates/main.html', [
], function () {
    return '<header class="bar top-bar">\r\n</header>\r\n<div class="view-container" style="background-color:{{=it.bgcolor||\'\'}}">\r\n    <div class="view-inner">\r\n    </div>\r\n</div>'
}),
...
define('apps/home/views/main', [
    ...
    'components/top_bar/view',
    'text!apps/home/templates/main.html',
    'components/footer/view',
    'components/modules/modules'
], function (t, i, e, n, s, a, l, o, r) {
    var c = $('#views');
    return t.View.extend({
        id: 'view-home',
        className: 'page-view view-home',
        template: i.template(o),
        initialize: function (i) {
            $('.page-view', c).removeClass('active'),
            $('#view-home').remove(),
            c.append(this.$el),
            this.model = new a,
            this.model.id = i,
        ...
        render: function () {
            ...
            $.loading('hide'),
            (1 == this.model.get('top_pendant') || void 0 == this.model.get('top_pendant')) && $('.top-bar', this.$el).html((new l).render().$el);
            var t = this;
            if ($.each(this.model.get('data'), function (i, e) {
                t.renderModule(e.type, e.content)
            }), 5 != this.model.get('type')) {
                var i = 'home';
                this.feature_id && (i = 'feature'),
                this.$el.append((new r).render().$el),
                this.$el.append((new n).render({
                    type: i,
                    id: this.feature_id
                }).$el),
                (1 == this.model.get('side_pendant') || 'undefined' == typeof this.model.get('side_pendant')) && this.$el.append((new s).render({
                    type: i
                }).$el)
            }
            return this
