...
!function (global) {
    ...
    function newContext(e) {
        function t(e) {
            var t,
            i;
            for (t = 0; t < e.length; t++) if (i = e[t], '.' === i) e.splice(t, 1),
            t -= 1;
             else if ('..' === i) {
        ...
        function i(e, i, r) {
            ...
            v = w.map,
            x = v && v['*'];
            if (e && (e = e.split('/'), d = e.length - 1, w.nodeIdCompat && jsSuffixRegExp.test(e[d]) && (e[d] = e[d].replace(jsSuffixRegExp, '')), '.' === e[0].charAt(0) && g && (m = g.slice(0, g.length - 1), e = m.concat(e)), t(e), e = e.join('/')), r && v && (g || x)) {
                a = e.split('/');
        ...
        function a(e, t, r, n) {
            ...
            e && (d ? h = s && s.normalize ? s.normalize(e, function (e) {
                return i(e, p, n)
            })  : - 1 === e.indexOf('!') ? i(e, p, n)  : e : (h = i(e, p, n), c = o(h), d = c[0], h = c[1], r = !0, a = q.nameToUrl(h))),
        ...
        return E = {
            ...
            exports: function (e) {
                ...
                e.map.isDefine ? e.exports ? j[e.map.id] = e.exports : e.exports = j[e.map.id] = {
                }
                 : void 0
            },
            module: function (e) {
                ...
                u(r, 'defined', bind(this, function (r) {
                    ...
                    return this.map.unnormalized ? (r.normalize && (l = r.normalize(l, function (e) {
                        ...
                        try {
                            ...
                            return c(makeError('fromtexteval', 'fromText eval for ' + t + ' failed: ' + p, p, [
                                t
                            ]))
                        }
                        d && (useInteractive = !0),
        ...
        q = {
            ...
            configure: function (e) {
                ...
                e.packages && each(e.packages, function (e) {
                    ...
                    w.pkgs[i] = e.name + '/' + (e.main || 'main').replace(currDirRegExp, '').replace(jsSuffixRegExp, '')
                }),
                eachProp(S, function (e, t) {
                    e.inited || e.map.unnormalized || (e.map = a(t, null, !0))
                }),
                (e.deps || e.callback) && q.require(e.deps || [
                ], e.callback)
            },
            ...
            makeRequire: function (t, n) {
                ...
                mixin(o, {
                    ...
                    toUrl: function (e) {
                        ...
                        o = e.split('/') [0],
                        a = '.' === o || '..' === o;
                        return - 1 !== n && (!a || n > 1) && (r = e.substring(n, e.length), e = e.substring(0, n)),
            ...
            completeLoad: function (e) {
                ...
                if (q.defQueueMap = {
                    ...
                    if (!(!w.enforceDefine || a && getGlobal(a))) return n(e) ? void 0 : c(makeError('nodefine', 'No define call for ' + e, null, [
                        e
                    ]));
                    h([e,
                    o.deps || [
            ...
            nameToUrl: function (e, t, i) {
                ...
                if (req.jsExtRegExp.test(e)) s = e + (t || '');
                    ...
                    for (r = w.paths, n = e.split('/'), o = n.length; o > 0; o -= 1) if (a = n.slice(0, o).join('/'), u = getOwn(r, a)) {
                        isArray(u) && (u = u[0]),
                        n.splice(0, o, u);
                        break
                    }
                ...
                if (!n(t.id)) {
                    ...
                    return eachProp(S, function (e, r) {
                        0 !== r.indexOf('_@r') && each(e.depMaps, function (e) {
                            return e.id === t.id && i.push(r),
                            !0
                        })
                    }),
                    c(makeError('scripterror', 'Script error for "' + t.id + (i.length ? '", needed by: ' + i.join(', ')  : '"'), e, [
                        t.id
                    ]))
                }
            }
    ...
    if ('undefined' == typeof define) {
        ...
        req.load = function (e, t, i) {
            ...
            if (isWebWorker) try {
                ...
                e.onError(makeError('importscripts', 'importScripts failed for ' + t + ' at ' + i, o, [
                    t
                ]))
            }
        },
        ...
        define = function (e, t, i) {
            ...
            n ? (n.defQueue.push([e,
            t,
            i]), n.defQueueMap[e] = !0)  : globalDefQueue.push([e,
            t,
            i])
        },
        define.amd = {
