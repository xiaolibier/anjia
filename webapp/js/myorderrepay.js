...
$(function(){
	...
	function changeOrderInfoHtml(data){
		...
		var poundageRepaymentTypeDesc = dd.poundageRepaymentTypeDesc || "";
		var noRepaymentTimes = dd.noRepaymentTimes || 0;	
		g.repaymentRecordId = repaymentRecordId;		
		var html = [];
		html.push('<li class="repayment-list-detail">');
		...
		html.push('<i class="common-ico product-ico"></i>订单信息');
		html.push('</div>');
		html.push('</div>');
		...
		html.push('<div class="box-item">');
		html.push('<div class="box-item-text">');
		html.push('<p><i class="common-ico product-tip1"></i>审批分期金额：<span class="color-green">' + packageMoney + '</span>元</p>');
		html.push('</div>');
		html.push('</div>');
		html.push('<div class="box-item">');
		html.push('<div class="box-item-text">');
		html.push('<p><i class="common-ico product-tip1"></i>审批分期期数：<span class="color-green">' + fenQiTimes + '</span>期</p>');
		html.push('</div>');
		html.push('</div>');
		html.push('<div class="box-item">');
		html.push('<div class="box-item-text">');
		...
		html.push('<div class="box-item">');
		html.push('<div class="box-item-text">');
		html.push('<p><i class="common-ico product-tip2"></i>服务费支付方式：<span class="color-green">' + poundageRepaymentTypeDesc + '</span></p>');
		html.push('</div>');
		html.push('</div>');
		html.push('<div class="box-item">');
		html.push('<div class="box-item-text">');
		...
		html.push('</div>');
		html.push('</div>');
		html.push('<div class="order-item-top" style="border-top:1px solid #f2f2f2;border-bottom:none;">');
		html.push('<div class="order-type-name">');
		html.push('<i class="common-ico product-ico"></i>付款明细');
		html.push('</div>');
		html.push('</div>');
