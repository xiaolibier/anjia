...
__html__.push('<li><a href="/anjia/about.html?typePageId=3" class="'+((typePageId == '3')&&"selected")+'"><span><i>关于我们</i></span></a></li>');
__html__.push('<li class="no-right-border"><a href="/anjia/strategy.html?typePageId=4" class="'+((typePageId == '4')&&"selected")+'"><span><i>小燕子攻略</i></span></a></li>');
__html__.push('</ul>');
__html__.push('</div>');
__html__.push('</div>');
__html__.push('</div>');
