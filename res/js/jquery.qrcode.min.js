...
a.addData(h.text);
a.make();
c = r('<table></table>').css('height', h.height + 'px').css('border', '0px').css('border-collapse', 'collapse').css('background-color', h.background);
d = h.width / a.getModuleCount();
b = h.height / a.getModuleCount();
for (e = 0; e < a.getModuleCount(); e++) {
    f = r('<tr></tr>').css('height', b + 'px').appendTo(c);
    for (i = 0; i < a.getModuleCount(); i++) r('<td></td>').css({'width': d + 'px','height': d + 'px'}).css('background-color', a.isDark(e, i) ? h.foreground : h.background).appendTo(f)
}
}
a = c;
