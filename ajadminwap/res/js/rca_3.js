...
$(function(){
	...
	function sendQueryOrderListHttp(sys){
		g.httpTip.show();
		var url = Base.serverUrl + "md/order/findThirdRiskManagementOrder";
		var condi = {};
	...
	function changeOrderListHtml(data){
		...
		for(var i = 0,len = obj.length; i < len; i++){
			...
			html.push('<td><a href="javascript:checkOrder(\''+orderId+'\')" class="common_a_btn">查看</a> <a href="javascript:firstTrial(\''+orderId+'\')" class="common_a_btn">终审</a> <a href="javascript:creditReporting(\''+orderId+'\')" class="common_a_btn">91征信</a></td>');
			html.push('</tr>');
		}
		html.push('</table>');
	...
	window.firstTrial = function(orderId){
		var orderId = orderId || "";
		var money = money || 0;
		location.href="../html/rca_audit_3.html?orderId="+orderId;
	}
	//91征信
