...
$(function(){
	...
	function sendQueryOrderListHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "md/order/thirdApproveOrderReport";
		var condi = {};
	...
	function changeOrderListHtml(data){
		...
		var thirdApproveReport = d.thirdApproveReport || "";
		...
		html.push('<div class="rca_textarea_1"><span class="text">复审报告</span><textarea disabled="disabled" id="secondApproveReport" class="common_area">'+secondApproveReport+'</textarea></div>');
		html.push('<div class="rca_textarea_1"><span class="text">终审报告</span><textarea disabled="disabled" id="thirdApproveReport" class="common_area">'+thirdApproveReport+'</textarea></div>');
	...
	window.first_approveOrder = function(approveResult){
		var url = Base.serverUrl + "md/order/thirdApproveOrder";
		var condi = {};
		condi.packageMoney = $("#packageMoney").val() || 0;
		condi.fenQiTimes = $("#fenQiTimes").val() || "";
		condi.approveReport = $("#thirdApproveReport").val() || "";
		condi.orderId = g.orderId;
		condi.login_token = g.login_token;
