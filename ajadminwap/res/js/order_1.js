...
$(function(){
	...
	function sendQueryOrderListHttp(sys){
		g.httpTip.show();
		var url = Base.serverUrl + "md/order/findOrderByQuery";
		var condi = {};
	...
	function changeOrderListHtml(data){
		...
		for(var i = 0,len = obj.length; i < len; i++){
			...
			html.push('<td><a href="javascript:checkOrder(\''+orderId+'\')" class="common_a_btn">查看</a></td>');
			html.push('</tr>');
		}
		html.push('</table>');
	...
	function checkOrder(orderId){
		var orderId = orderId || "";
		var money = money || 0;
		location.href="../html/ViewOrderDetail.html?orderId="+orderId;
	}
