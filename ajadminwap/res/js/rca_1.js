...
$(function(){
	...
	function sendQueryOrderListHttp(sys){
		g.httpTip.show();
		var url = Base.serverUrl + "md/order/findFirstRiskManagementOrder";
		var condi = {};
	...
	function changeOrderListHtml(data){
		...
		for(var i = 0,len = obj.length; i < len; i++){
			...
			html.push('<td><a href="javascript:editOrder(\''+orderId+'\')" class="common_a_btn">编辑</a> <a href="javascript:firstTrial(\''+orderId+'\')" class="common_a_btn">初审</a> <a href="javascript:creditReporting(\''+orderId+'\')" class="common_a_btn">91征信</a></td>');
			html.push('</tr>');
		}
		html.push('</table>');
	...
	window.editOrder = function(orderId){
		var orderId = orderId || "";
		var money = money || 0;
		location.href="../html/ModifyOrder.html?orderId="+orderId;
	}
	//初审
	window.firstTrial = function(orderId){
		var orderId = orderId || "";
		var money = money || 0;
		location.href="../html/rca_audit_1.html?orderId="+orderId;
	}
	//91征信
