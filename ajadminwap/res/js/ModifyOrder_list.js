...
$(function () {
    ...
    function ReadOrderInfo() {
        $.ajax({//处理字段、图片、并存放全局变量
            ...
            url: Base.serverUrl + "md/order/findUpdateOrderInfo",
    ...
    window.DelPic = function (orderMaterialId) {
        ...
        var url = Base.serverUrl + "md/order/deleteOrderMaterialByOrderId";
        $.ajax({
            url: url,
    ...
    function sendGetProductHttp(companyId) {
        g.httpTip.show();
        var url = Base.serverUrl + "common/product/findByQuery";
        var condi = {};
    ...
    function SaveData(e) {
        ...
        g.httpTip.show();
        var url = Base.serverUrl + "md/order/updateOrderMoney";
        var condi = {};
		 condi.customerInfo = [];
    ...
    function uploadBtnUp(upType) {
        ...
        var url = Base.serverUrl + 'md/order/uploadOrderMaterialImage';//"order/uploadOrderMaterial";
        $.ajaxFileUpload({
            url: url, data: condi,
    ...
    function saveUploadFile(upType) {
        ...
        condi.orderId = g.orderId;
        condi.orderMaterialType = upType;
        var url = Base.serverUrl + "md/order/uploadOrderMaterialFile";
        $.ajaxFileUpload({
            url: url, data: condi,
            secureuri: false, //一般设置为false
    ...
    function RefreshImage(orderId,upType) {
        $.ajax({
            url: Base.serverUrl + "md/order/findOrderMaterialByOrderId",
    ...
    $("#packageMoney").bind("change", countFee);
