...
$(function(){
	...
	function sendQueryOrderListHttp(sys){
		g.httpTip.show();
		var url = Base.serverUrl + "md/order/findSecondRiskManagementOrder";
		var condi = {};
	...
	function changeOrderListHtml(data){
		...
		for(var i = 0,len = obj.length; i < len; i++){
			...
			html.push('<td><a href="javascript:checkOrder(\''+orderId+'\')" class="common_a_btn">查看</a> <a href="javascript:firstTrial(\''+orderId+'\')" class="common_a_btn">复审</a> <a href="javascript:creditReporting(\''+orderId+'\')" class="common_a_btn">91征信</a></td>');
			html.push('</tr>');
		}
		html.push('</table>');
	...
	//查看
	window.checkOrder = function(orderId){
		var orderId = orderId || "";
		var money = money || 0;
		location.href="../html/ModifyOrder_only.html?orderId="+orderId;
	}
	//初审
	window.firstTrial = function(orderId){
		var orderId = orderId || "";
		var money = money || 0;
		location.href="../html/rca_audit_2.html?orderId="+orderId;
	}
	//91征信
	window.creditReporting = function(orderId){
		var orderId = orderId || "";
		var money = money || 0;
		location.href="../html/credit_reporting.html?orderId="+orderId;
	}
