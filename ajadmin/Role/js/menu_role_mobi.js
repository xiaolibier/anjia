...
$(function(){
	...
	function sendQueryTreeByRoleIdHttp(id){
		g.httpTip.show();
		var url = Base.serverUrl + "authority/phone/queryAdminMenuByRoleId";
		var condi = {};
		condi.login_token = g.login_token;
		condi.roleId = id;
		$.ajax({
	...
	function sendInsertTreeByRoleIdHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "roleAuthority/phone/insertAdminMenuRoleAuthority";
		var condi = {};
		condi.login_token = g.login_token;
	...
	**/
	...
	function sendQueryListHttp(){
		g.httpTip.show();
		var url = Base.serverUrl + "authority/phone/queryAdminMenuTree";
		var condi = {};
		condi.login_token = g.login_token;
		//~ condi.pageSize = g.pageSize;
		//~ condi.currentPageNum = g.currentPage;
